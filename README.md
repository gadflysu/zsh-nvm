# zsh-nvm [![Build Status](https://github.com/gadflysu/zsh-nvm/actions/workflows/test.yml/badge.svg)](https://github.com/gadflysu/zsh-nvm/actions/workflows/test.yml)
